		...
		if ($retval == 0) {
			...
			if (isset($_POST["df"]) && isset($_POST["dt"]) && isset($_POST["team"]))  {
				...
				while ($row = mssql_fetch_assoc($results)) {
					$curr = $row['DATE_TRX3'] . " " . str_pad($row['TIME_TRX'],6,"0",STR_PAD_LEFT);
					$currts = strtotime($curr);
					$tableRowID = date('Ymd',$currts) . "_" . trim($row['ID_SO']) . "_" . $row['SUFX_SO'] . "_" . $row['ID_OPER'];
					...
					print("		<tr class='sample'>\n");
					print("			<td class='sample'><div id='ST_" . $tableRowID . "'>" . date('m/d/Y h:i:s A',$currts) . "</div></td>\n");
					print("			<td class='sample'><div id='ET_" . $tableRowID . "'></div></td>\n");
					print("			<td class='sample'>" . $row['ID_SO'] . "</td>\n");
					print("			<td class='sample'>" . $row['SUFX_SO'] . "</td>\n");
					print("			<td class='sample'>" . $row['ID_OPER'] . "</td>\n");
					print("			<td class='sample'>" . $row['ID_ITEM_PAR'] . "</td>\n");
					print("			<td class='sample'>" . $row['QTY_ORD'] . "</td>\n");
					print("			<td class='sample'><div id='QR_" . $tableRowID . "'></div></td>\n");
					print("			<td class='sample'><div id='QC_" . $tableRowID . "'></div></td>\n");
					print("			<td class='sample'>" . $MIN_MACH_SF . "</td>\n");
					print("			<td class='sample'><div id='EM_" . $tableRowID . "'></div></td>\n");
					print("		</tr>\n");
				}
				print("</table>\n");
				print("	</br>\n");
				...
				while ($row = mssql_fetch_assoc($results)) {
					$tableRowID = trim($row['ID_SO']) . "_" . $row['SUFX_SO'] . "_" . $row['ID_OPER'];

					$curr = $row['DATE_TRX3'] . " " . str_pad($row['TIME_TRX'],6,"0",STR_PAD_LEFT);
					$currts = strtotime($curr);


					//replace div "id='ET_" . $tableRowID . "'" with   date('m/d/Y h:i:s A',$currts)
					//replace div "id='QR_" . $tableRowID . "'"
					//replace div "id='QC_" . $tableRowID . "'" with	$row['QTY_GOOD']
					//replace div "id='EM_" . $tableRowID . "'" with 	$row['QTY_GOOD'] * $row['HR_MACH_SF']
				...
				print(" <form action='activity2.php' method='POST'>");
				print(" <table>");
				print(" 	<tr>");
