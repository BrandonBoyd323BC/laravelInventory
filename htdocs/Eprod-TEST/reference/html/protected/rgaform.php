	...
	if ($ua['short_name'] == 'Chrome') {
		...
		if ($retval == 0) {
			...
			if ($retval == 0) {
				...
				print("           		<option value='Waiting For Return'>Waiting for Return</option>\n");						
				print("           		<option value='Customer Waiting'>Customer Waitng</option>\n");
				print("           		<option value='NSA Waiting'>NSA Waiting</option>\n");
				print("           		<option value='Resolved'>Resolved/Needs Internal ISO Investigation</option>\n");
