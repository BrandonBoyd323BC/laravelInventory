<?php
	...
	PrintHeaderJQ2('Shop Order Approval','default.css','soApproval.js');
	...
	if ($retval == 0) {
		...
		if ($retval == 0) {
			...
			print(" <form id='SO_Approval_Form' method='post' enctype='multipart/form-data'>\n");			
			print(" <table>\n");
			print(" 	<tr>\n");
			print(" 		<th colspan=2>Enter New Approval Records: </th>\n");
			print(" 	</tr>\n");
			print("		<tr id='tr_so1'>\n");
