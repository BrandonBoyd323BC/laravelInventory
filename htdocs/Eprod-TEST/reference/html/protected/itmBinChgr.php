<?php
	...
	PrintHeaderJQ2('Item Primary Bin Changer','default.css','itmBinChgr.js');
	...
	if ($retval == 0) {
		...
		if ($retval == 0) {
			...
			print("		</div></td>");
			print(" 		<td><INPUT id='submit' type='button' value='Lookup' onClick=\"getItemBinInfo()\" >  <INPUT id='reset' type='button' value='Clear' onClick=\"clearForm()\" ></td>\n");
			print(" 	</tr>");
			...
			print(" 	</br>\n");
			print(" </div>\n");
			print(" <div id='dataBinDiv'>\n");
			print(" 	</br>\n");
			print(" </div>\n");
			print(" <div id='dataOrdLinDiv'>\n");
			print(" 	</br>\n");
			print(" </div>\n");
