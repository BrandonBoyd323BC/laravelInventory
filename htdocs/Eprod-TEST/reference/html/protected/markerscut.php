<?php
	...
	PrintHeaderJQ2('Markers Cut','default.css','markerscut.js');
	...
	if ($retval == 0) {
		...
		if ($retval == 0) {
			...
			//print(" <form id='Marker_Form' method='post' enctype='multipart/form-data'>\n");
			print(" <table>\n");
			print(" 	<tr>\n");
			...
			print(" 		<td>\n");
			print("				<input id='marker_id' type=text onkeypress='searchKeyPress(event);'size=6 tabindex=2>\n");
			print("			</td>\n");
			print(" 	</tr>\n");
			print(" 	<tr></tr>\n");
			print(" 	<tr>\n");
			...
			print(" 		<th colspan=2>Marker Lookup<input id='searchMarkerID' name='searchMarkerID' type='text' value='ALL' onblur=\"numRecsChange()\"></input><th>\n");
			print(" 	</tr>\n");
			print(" </table>\n");
