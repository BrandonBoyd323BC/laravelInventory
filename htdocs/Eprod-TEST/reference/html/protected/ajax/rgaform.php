				...
				switch($Action) {
					...
					case "refresh_mainDiv":
						...
						if (strpos($UserRow['EMP_ROLE'], ":RGA-CS:") !== FALSE ) {
							...
							$ret .= " 	<th colspan=7>RGA Requests for Review</th>\n";
							$ret .= " 	</tr>\n";
							$ret .= " 	<tr>\n";
							$ret .= " 		<th>RGA #</th>\n";
							$ret .= " 		<th>Customer #</th>\n";
							...
							$sql .= " b.NAME_CUST, ";
							$sql .= " b.ID_USER_ADD, ";
							$sql .= " i.RGA_ISO_STATUS ";
							$sql .= " from  nsa.RGA_BASE" . $DB_TEST_FLAG . " b ";
							$sql .= " left join nsa.RGA_INVEST" . $DB_TEST_FLAG . " i ";
							$sql .= " on b.rowid = i.RGA_BASE_rowid ";
							$sql .= " left join nsa.RGA_LINE" . $DB_TEST_FLAG . " l ";
							$sql .= " on b.rowid = l.RGA_BASE_rowid ";
							$sql .= " where b.RGA_STATUS like '".$rgaStatus ."' ";
							if ($isoStatus == '%') {
								$sql .= " and (i.RGA_ISO_STATUS like '".$isoStatus ."' OR i.RGA_ISO_STATUS is NULL)";	
							} else {
								$sql .= " and (i.RGA_ISO_STATUS like '".$isoStatus ."')";	
							}
						...
						if (strpos($UserRow['EMP_ROLE'], ":RGA-SHIP:") !== FALSE ) {
							$ret .= " <table class='sample'>\n";
							$ret .= " 	<tr class='blueHeader'>\n";
							$ret .= " 		<th colspan=7>RGA Shipping Requests for Review</th>\n";
							$ret .= " 	</tr>\n";
							$ret .= " 	<tr>\n";
							$ret .= " 		<th>RGA #</th>\n";
							$ret .= " 		<th>Customer #</th>\n";
						...
						if (strpos($UserRow['EMP_ROLE'], ":RGA-ISO:") !== FALSE || strpos($UserRow['EMP_ROLE'], ":RGA-FINANCE:") !== FALSE) {
							$ret .= " <table class='sample'>\n";
							$ret .= " 	<tr class='blueHeader'>\n";
							$ret .= " 		<th colspan=7>RGA ISO Requests for Review</th>\n";
							$ret .= " 	</tr>\n";							
							$ret .= " 	<tr>\n";
							$ret .= " 		<th>RGA #</th>\n";
							$ret .= " 		<th>Customer #</th>\n";
					...
					case "form_newreq":	
						...
						for ($y = 1; $y <= 10; $y++) {
							...
							$z = $y+1;
							$ret .= "	<tr class='dbd' rowspan=4  id='tr_ord".$y.".1' style='".$style."'>\n";
							$ret .= "		<td colspan=4></td>\n";
							$ret .= "	</tr>\n";
							...
							$ret .= "		<td>Date Ship ".$y." </br> (yyyy-mm-dd):</td>\n";
							$ret .= "		<td><input id='txt_dateShipped".$y."' name='txt_dateShipped".$y."' type='text'></input></td>\n";
							$ret .= "	</tr>\n";
							$ret .= "	<tr rowspan=4 id='tr_plus".$y."' style='".$style."'>\n";
						...
						$ret .= "		<td><input id='txt_email_notify' name='txt_email_notify' type='email' style = 'width: 500px;' value='' ></input></td>\n";
						$ret .= "	</tr>\n";
						*/
						$ret .= "	<tr class='dbc'>\n";
						...
						for ($y = 1; $y <= 10; $y++) {
							...
							$z = $y +1;
							$ret .= "	<tr class='dbc' id='tr_itm".$y.".1' style='".$style."'>\n";
							$ret .= "       <td colspan=2></td>\n";
							$ret .= "		<td>Item Recieved".$y." :</td>\n";
							...
							$ret .= "		<td>Comments".$y.":</td>\n";
							$ret .= "		<td colspan=4><textarea id='txt_ship_comments".$y."' name='txt_ship_comments".$y."' cols='55'></textarea></td>\n";
							$ret .= "	</tr>\n";
							$ret .= "	<tr rowspan=4 id='tr_plus_itm".$y."' style='".$style."'>\n";
							$ret .= "		<td colspan=4><font style='cursor: hand' title='Add Blank Record' onclick=\"showItmInputRow('$z','5')\">+Blank   </font><font style='cursor: hand' title='Copy Previous Record' onclick=\"showItmInputRow('$z','5','1')\">+Clone</font></td>\n";
							$ret .= "	</tr>\n";	
						}	

						$ret .= "	<tr class='dbc'>\n";
						$ret .= "		<td>CC Email:</td>\n";
						$ret .= "		<td colspan=3><input id='txt_email_notify_ship' name='txt_email_notify_ship' type='email' style = 'width: 500px;' value='' ></input></td>\n";
						$ret .= "	</tr>\n";		
						$ret .= "	<tr class='dbc'>\n";
						...
						$ret .= "           <option value='Waiting for Return'>Waiting for Return</option>\n";						
						$ret .= "           <option value='Customer Waiting'>Customer Waitng</option>\n";
						$ret .= "           <option value='NSA Waiting'>NSA Waiting</option>\n";
						$ret .= "           <option value='Resolved/Needs Internal ISO Investigation'>Resolved/Needs Internal ISO Investigation</option>\n";
						$ret .= "           <option value='Closed'>Closed</option>\n";
						$ret .= "		</select></td>\n";
						$ret .= "	</tr>\n";
						$ret .= "	<tr class='dbc'>\n";
						$ret .= "		<td>CC Email:</td>\n";
						$ret .= "		<td colspan=3><input id='txt_email_notify_invest' name='txt_email_notify_invest' type='email' style = 'width: 500px;' value='' ></input></td>\n";
						$ret .= "	</tr>\n";
						$ret .= "	<tr class='dbc'>\n";
					...
					case "submit_newreq":
						if (isset($_POST["rgaNumber"]) && isset($_POST["custNumber"]) && isset($_POST["custName"]) && isset($_POST["city"]) && isset($_POST["state"]) && 
							...
							isset($_POST["authorized"]) && isset($_POST["selectSalesMgr"]) && isset($_POST["territory"]) && isset($_POST["descr"]) && 
							isset($_POST["rgaClass"]) && isset($_POST["followUp"]) && isset($_POST["addInfo"])  && isset($_POST["emailNotify"]) && isset($_POST["sendEmail"]) &&
							...
							$rgaStatus = "Waiting for Return";

							if ($rgaClass == "B") {
								$rgaStatus = "Customer Waiting";
							}
...
*/
							...
							while ($row = mssql_fetch_assoc($results)) {
								if (strpos($UserRow['EMP_ROLE'], ":RGA-CS:")) {
									...
									while ($row2 = mssql_fetch_assoc($results2)) {
										...
										$ret .= "		<td>Date Ship ".$y." (yyyy-mm-dd):</td>\n";
									...
									$rgaActionNeedCredit = '';
									$rgaActionNeedOther = '';
									if (strpos($row['ACTION_NEEDED'], ':Rework:') !== false) {
										error_log("ACTION NEEDED: Rework");
										$rgaActionNeedRework = 'CHECKED';
									}

									if (strpos($row['ACTION_NEEDED'], ':Replace:') !== false) {
										error_log("ACTION NEEDED: Replace");
										$rgaActionNeedReplace = 'CHECKED';
									}

									if (strpos($row['ACTION_NEEDED'], ':NonStk-Sample:') !== false) {
										error_log("ACTION NEEDED: NonStk-Sample");
										$rgaActionNeedNonStock = 'CHECKED';
									}
									
									if (strpos($row['ACTION_NEEDED'], ':Credit:') !== false) {
										error_log("ACTION NEEDED: Credit");
										$rgaActionNeedCredit = 'CHECKED';
									}

									if (strpos($row['ACTION_NEEDED'], ':Other:') !== false) {
										error_log("ACTION NEEDED: Other");
									...
									$ret .= "	<tr class='dbc' id='tr_RGA_RATING' style='diplay:table-row;'>\n";
									$ret .= "		<td>RGA Rating (choose one):</td>\n";
									$ret .= "		<td><input type='radio' id='1' ".$rgaRatingSelect1." name='level' value='1' $READONLY>Level 1</input></td>\n";
									$ret .= "		<td><input type='radio' id='2' ".$rgaRatingSelect2." name='level' value='2' $READONLY>Level 2</input></td>\n";
									$ret .= "		<td><input type='radio' id='3' ".$rgaRatingSelect3." name='level' value='3' $READONLY>Level 3</input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Findings:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_findings' name='txt_findings' cols='55' $READONLY >".$row['FINDINGS']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Cause:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_cause' name='txt_cause' cols='55' $READONLY >".$row['CAUSE']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Containment:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_contain' name='txt_contain' cols='55' $READONLY >".$row['CONTAINMENT']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Correction:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_corr' name='txt_corr' cols='55' $READONLY >".$row['CORRECTION']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "</table>\n";
									...
									$ret .= "		</td>\n";
									$ret .= "		<td colspan=5><textarea id='txt_desc' name='txt_desc' $READONLY>".$row['ACTION_DESCR']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td colspan=2>Is a Corrective Action Request (CAR) required? (select one)</td>\n";
									...
									$ret .= "		<td>CAR #</td>\n";
									$ret .= "		<td colspan=2><input id='txt_carNumber' name='txt_carNumber' type='text' $READONLY value='".$row['CAR_NUMBER']."' maxlength='25'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td colspan=2>Proposed action approved by:</td>\n";
									$ret .= "		<td colspan=2><input id='txt_approve' name='txt_approve' type='text' $READONLY value='".$row['APPROVED_BY']."' maxlength='30'></input></td>\n";
									$ret .= "		<td>Date (yyyy-mm-dd):</td>\n";
									$ret .= "		<td colspan=2><input id='txt_dateSubmit' name='txt_dateSubmit' type='text' $READONLY value='".$row['riDATE_APPROVED']."'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "</table>\n";
									...
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Department:</td>\n";
									$ret .= "		<td><input id='txt_dept' name='txt_dept' type='text' $READONLY value='".$row['DEPARTMENT']."' maxlength='25'></input></td>\n";
									$ret .= "		<td>Request/Error:</td>\n";
									$ret .= "		<td><select id='select_err' name='select_err' $READONLY>\n";
									...
									foreach($REQ_ERR as $SELECT_ERR) {
										...
										if (trim($row['REQ_ERR']) == trim($SELECT_ERR)) {
											$SELECTED = 'SELECTED';
											$CURRENT = '*';
										}
									...
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Workcenter:</td>\n";
									$ret .= "		<td><input id='select_workcenter' name='select_workcenter' type='text' $READONLY value='".$row['WORKCENTER']."' maxlength='40'></input></td>\n";
									$ret .= "		<td>Credit Invoice #:</td>\n";
									$ret .= "		<td><input id='txt_invoice' name='txt_invoice' type='text' $READONLY value='".$row['ID_INVC_CRED']."' maxlength='8'></input></td>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Team/Individual:</td>\n";
									$ret .= "		<td><input id='txt_team' name='txt_team' type='text' $READONLY value='".$row['ID_TEAM']."' maxlength='25'></input></td>\n";
									$ret .= "		<td>Component Costs:</td>\n";
									$ret .= "		<td><input id='txt_compCost' name='txt_compCost' type='text' $READONLY value='".$row['COST_COMP']."'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Error Type:</td>\n";
									$ret .= "		<td><input id='txt_errorType' name='txt_errorType' type='text' $READONLY value='".$row['ERR_TYPE']."'></input></td>\n";
									$ret .= "		<td>Labor Costs:</td>\n";
									$ret .= "		<td><input id='txt_laborCost' name='txt_laborCost' type='text' $READONLY value='".$row['COST_LAB']."'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Vendor ID:</td>\n";
									$ret .= "		<td><input id='txt_vendor' name='txt_vendor' type='text' $READONLY value='".$row['ID_VND']."' maxlength='6'></input></td>\n";
									$ret .= "		<td>Shipping Costs:</td>\n";
									$ret .= "		<td><input id='txt_shipCost' name='txt_shipCost' type='text' $READONLY value='".$row['COST_SHIP']."'></input></td>\n";
									$ret .= "	</tr>\n";				
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Part #:</td>\n";
									$ret .= "		<td><input id='txt_isoPartNumber' name='txt_isoPartNumber' type='text' $READONLY value='".$row['ID_ITEM_VND']."' maxlength='30'></input></td>\n";
									$ret .= "		<td>Total RGA Costs:</td>\n";
									$ret .= "		<td><input id='txt_totCost' name='txt_totCost' disabled type='text'  value='".$row['COST_TOT']."'></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>ISO Status:</td>\n";

									if(empty($row['isoRowID']) ) {
										$ret .= "		<td><select id='select_iso_status' name='select_iso_status' $READONLY>\n";
										$ret .= "           <option value=''>-- Select --</option>\n";
										$ret .= "           <option value='Drafted'>Drafted</option>\n";
										$ret .= "           <option value='Pending Extenuating Issues'>Pending Extenuating Issues</option>\n";
										$ret .= "           <option value='Waiting for Approval'>Waiting for Approval</option>\n";
										...
										foreach ($isoStatus as $SELECT_ISO_STATUS) {
											...
											if (trim($row['RGA_ISO_STATUS']) == trim($SELECT_ISO_STATUS)) {
												$SELECTED = 'SELECTED';
												$CURRENT = '*';
											}
									...
									$ret .= "		<td>RGA Status:</td>\n";
									$ret .= "		<td><select id='select_rga_status' name='select_rga_status' $READONLY>\n";
									...
									$RGA_STATUS_ARRAY = array(
										...
										array("Waiting for Return","Waiting for Return"),
										array("Customer Waiting","Customer Waiting"),
										array("NSA Waiting","NSA Waiting"),
										array("Resolved/Needs Internal ISO Investigation","Resolved/Needs Internal ISO Investigation"),
										array("Closed","Closed"),
									);
									for ($rowStat = 0; $rowStat < 9; $rowStat++) {
										$SELECTED = '';
										$CURRENT = '';
									...
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									//$ret .= "		<td colspan=7><input id='button_insertNewInvest' DISABLED name='button_insertNewInvest' type='button' $READONLY value='Submit'></input><div id='div_submitResp2' name='div_submitResp2'></div></td>\n";
									$ret .= "		<td colspan=4>\n";
									$ret .= " 			<input id='button_insertNewInvest' name='button_insertNewInvest' type='button' value='Submit' onclick=\"insertNewInvest()\" DISABLED></input>\n";
									$ret .= " 				**Send Email?<select id='sel_Email_insertNewInvest' name='sel_Email_insertNewInvest' DISABLED onchange=\"checkEnableButton('sel_Email_insertNewInvest','button_insertNewInvest')\">\n";
									//$ret .= " 				**Send Email?<select id='sel_Email_insertNewInvest' name='sel_Email_insertNewInvest' DISABLED>\n";
									$ret .= "   	        <option value=''>--Select--</option>\n";
									$ret .= "   	        <option value='Send'>Send</option>\n";
									$ret .= " 	    	    <option value='NoSend'>Do NOT Send</option>\n";
									$ret .= "			</select>\n";
					...
					case "updateBase":	
						...
						isset($_POST["rgaClass"]) && isset($_POST["followUp"]) && isset($_POST["addInfo"]) && isset($_POST["BaseRowID"]) && isset($_POST["emailNotify"]) &&
						isset($_POST["itemNumber1"]) && isset($_POST["orderNumber1"]) && isset($_POST["poNumber1"]) && isset($_POST["invoiceNumber1"]) && isset($_POST["quant1"]) && isset($_POST["dateShipped1"]) &&
						isset($_POST["itemNumber2"]) && isset($_POST["orderNumber2"]) && isset($_POST["poNumber2"]) && isset($_POST["invoiceNumber2"]) && isset($_POST["quant2"]) && isset($_POST["dateShipped2"]) &&
						isset($_POST["itemNumber3"]) && isset($_POST["orderNumber3"]) && isset($_POST["poNumber3"]) && isset($_POST["invoiceNumber3"]) && isset($_POST["quant3"]) && isset($_POST["dateShipped3"]) &&
						isset($_POST["itemNumber4"]) && isset($_POST["orderNumber4"]) && isset($_POST["poNumber4"]) && isset($_POST["invoiceNumber4"]) && isset($_POST["quant4"]) && isset($_POST["dateShipped4"]) &&
						...
						isset($_POST["itemNumber10"]) && isset($_POST["orderNumber10"]) && isset($_POST["poNumber10"]) && isset($_POST["invoiceNumber10"]) && isset($_POST["quant10"]) && isset($_POST["dateShipped10"])
							...
							if ($rgaClass == "B" && $rgaStatus == "Waiting for Return") {
								$rgaStatus = "Customer Waiting";
							}
							...
							isset($_POST["itemReceived10"]) && isset($_POST["dateReceived10"]) && isset($_POST["quantity10"]) && isset($_POST["condition10"]) && isset($_POST["receivedBy10"]) && isset($_POST["carrier10"]) && isset($_POST["trackingNumber10"]) && isset($_POST["shipComments10"])) 
						{
							...
							for ($y = 1; $y <= 10; $y++) {
								if(${"itemReceived".$y} <> '' || ${"dateReceived".$y} <> '' || ${"quantity".$y} <> '' || 
									...
									$sql  = "UPDATE nsa.RGA_BASE" . $DB_TEST_FLAG . " ";
									$sql .= " set RGA_STATUS = 'Customer Waiting', ";
									$sql .= " ID_USER_CHG = '" . $UserRow['ID_USER'] . "', ";
									$sql .= " DATE_CHG = GetDate() ";
									$sql .= " WHERE RGA_NUMBER = '". $rgaNumber ."'";
									QueryDatabase($sql, $results);
							...
							while ($row = mssql_fetch_assoc($results)) {
								 if (strpos($UserRow['EMP_ROLE'], ":RGA-SHIP:")) {
									...
									*/
									...
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Error Type:</td>\n";
									$ret .= "		<td><input id='txt_errorType' name='txt_errorType' type='text' $READONLY value='".$row['ERR_TYPE']."' maxlength='40'></input></td>\n";
									$ret .= "		<td>Labor Costs:</td>\n";
									$ret .= "		<td><input id='txt_laborCost' name='txt_laborCost' type='text' $READONLY value='".$row['COST_LAB']."'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									...
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									//$ret .= "		<td colspan=7><input id='button_SubmitNew2' name='button_SubmitNew2' DISABLED type='button' $READONLY value='Submit'></input><div id='div_submitResp2' name='div_submitResp2'></div></td>\n";
									$ret .= "		<td colspan=4>\n";
									$ret .= " 			<input id='button_updateRgaInvest' name='button_updateRgaInvest' type='button' value='Save' onclick=\"updateRgaInvest()\" DISABLED></input>\n";
									$ret .= " 			**Send Email?<select id='sel_Email_updateRgaInvest' name='sel_Email_updateRgaInvest' DISABLED onchange=\"checkEnableButton('sel_Email_updateRgaInvest','button_updateRgaInvest')\">\n";
									$ret .= "   	        <option value=''>--Select--</option>\n";
									$ret .= "   	        <option value='Send'>Send</option>\n";
									$ret .= " 	    	    <option value='NoSend'>Do NOT Send</option>\n";
									$ret .= "			</select>\n";
									$ret .= "			<div id='div_submitResp_updateRgaInvest' name='div_submitResp_updateRgaInvest'></div>\n";
									$ret .= "		</td>\n";									
									$ret .= "	</tr>\n";
									$ret .= "</table>\n";
								}
					...
					case "submit_newreq_iso":
						if (isset($_POST["rgaNumber"]) && isset($_POST["level"]) && isset($_POST["findings"]) && isset($_POST["cause"]) && isset($_POST["contain"]) && isset($_POST["corr"]) && isset($_POST["actionNeed"]) &&
							...
							isset($_POST["itemNumber"]) && isset($_POST["shipCost"]) && isset($_POST["isoStatus"]) && isset($_POST["workcenter"]) && isset($_POST["rgaStatus"]) && isset($_POST["sendEmail"])) {
							...
							while ($row = mssql_fetch_assoc($results)) {
								 if (strpos($UserRow['EMP_ROLE'], ":RGA-ISO:") || strpos($UserRow['EMP_ROLE'], ":RGA-ISO-ADMIN:") || strpos($UserRow['EMP_ROLE'], ":RGA-FINANCE:")) {
									...
									*/
									...
									$ret .= "	<tr class='dbc' id='tr_RGA_RATING' style='diplay:table-row;'>\n";
									$ret .= "		<td>RGA Rating (choose one):</td>\n";
									$ret .= "		<td><input type='radio' ".$rgaRatingSelect1." id='1' name='level' value='1' >Level 1</input></td>\n";
									$ret .= "		<td><input type='radio' ".$rgaRatingSelect2." id='2' name='level' value='2' >Level 2</input></td>\n";
									$ret .= "		<td><input type='radio' ".$rgaRatingSelect3." id='3' name='level' value='3' >Level 3</input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Findings:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_findings' name='txt_findings' cols='55' $READONLY_FIN>".$row['FINDINGS']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Cause:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_cause' name='txt_cause' cols='55' $READONLY_FIN>".$row['CAUSE']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Containment:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_contain' name='txt_contain' cols='55' $READONLY_FIN>".$row['CONTAINMENT']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Correction:</td>\n";
									$ret .= "		<td colspan=3><textarea id='txt_corr' name='txt_corr' cols='55' $READONLY_FIN>".$row['CORRECTION']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "</table>\n";
									$ret .= "<table width='850' >\n";
									$ret .= "	<th colspan='7'></th>\n";
									...
									$ret .= "		<td><strong>Action Needed:</strong></td>\n";
									$ret .= "		<td style='text-align:left;'>\n";
									$ret .= "			<input type='checkbox' id='action_Rework' name='action_Rework' $rgaActionNeedRework value=':Rework:' $READONLY_FIN>Rework</input><br />\n";
									$ret .= "			<input type='checkbox' id='action_Replace' name='action_Replace' $rgaActionNeedReplace value=':Replace:' $READONLY_FIN>Replace</input><br />\n";
									$ret .= "			<input type='checkbox' id='action_NonStk-Sample' name='action_NonStk-Sample' $rgaActionNeedNonStock value=':NonStk-Sample:' $READONLY_FIN>NonStock/Sample</input><br />\n";
									$ret .= "			<input type='checkbox' id='action_Credit' name='action_Credit' $rgaActionNeedCredit value=':Credit:' $READONLY_FIN>Credit</input><br />\n";
									$ret .= "			<input type='checkbox' id='action_Other' name='action_Other' $rgaActionNeedOther value=':Other:' $READONLY_FIN>Other</input>\n";
									$ret .= "		</td>\n";
									$ret .= "		<td colspan=5><textarea id='txt_desc' name='txt_desc' $READONLY_FIN>".$row['ACTION_DESCR']."</textarea></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td colspan=2>Is a Corrective Action Request (CAR) required? (select one)</td>\n";
									$ret .= "		<td><input type='radio' ".$carFlagN." id='N' name='option' value='N'>No</input></td>\n";
									$ret .= "		<td><input type='radio' ".$carFlagY." id='Y' name='option' value='Y'>Yes</input></td>\n";
									$ret .= "		<td>CAR #</td>\n";
									$ret .= "		<td colspan=2><input id='txt_carNumber' name='txt_carNumber' type='text'  value='".$row['CAR_NUMBER']."' $READONLY_FIN maxlength='25'></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td colspan=2>Proposed action approved by:</td>\n";
									$ret .= "		<td colspan=2><input id='txt_approve' name='txt_approve' type='text' value='".$row['APPROVED_BY']."' $READONLY_FIN maxlength='30'></input></td>\n";
									$ret .= "		<td>Date (yyyy-mm-dd):</td>\n";
									$ret .= "		<td colspan=2><input id='txt_dateSubmit' name='txt_dateSubmit' type='text' value='".$row['riDATE_APPROVED']."' $READONLY_FIN></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "</table>\n";
									$ret .= "<table width='850' >\n";
									$ret .= " 	<th colspan='4'>For Tracking Only</th>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Department:</td>\n";
									$ret .= "		<td><Select id='select_dept' name='select_dept' onchange=\"checkDept()\" $READONLY_FIN>\n";
									$ret .= "			<option value=''>--Select--</option>\n";
									...
									foreach ($DEPT_NAME as $SELECT_DEPT){
										...
										if (trim($row['DEPARTMENT']) == trim($SELECT_DEPT)) {
											$SELECTED = 'SELECTED';
											$CURRENT = '*';
										}
									...
									$ret .= "		</Select></td>\n";
									$ret .= "		<td>Request/Error:</td>\n";
									$ret .= "		<td><select id='select_err' name='select_err' $READONLY_FIN>\n";
									$ret .= "			<option value=''>--Select--</option>\n";
									...
									$ret .= "		<td><Select id='select_workcenter' name='select_workcenter' $READONLY_FIN_WC onchange=\"checkWorkcenter()\" $READONLY_FIN>\n";
									$ret .= "			<option value=''>--Select--</option>\n";
									...
									while ($rowwc = mssql_fetch_assoc($resultswc)){
										...
										if (trim($row['WORKCENTER']) == $rowwc['WC_GROUP']) {
											$SELECTED = 'SELECTED';
											$CURRENT = '*';
										}
									...
									$ret .= "		</Select></td>\n";
									$ret .= "		<td>Credit Invoice #:</td>\n";
									$ret .= "		<td><input id='txt_invoice' name='txt_invoice' type='text'  value='".$row['ID_INVC_CRED']."' maxlength='8'></input></td>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Team/Individual:</td>\n";
									$ret .= "		<td><input id='txt_team' name='txt_team' type='text' value='".$row['ID_TEAM']."' $READONLY_FIN maxlength='25'></input></td>\n";
									$ret .= "		<td>Component Costs:</td>\n";
									$ret .= "		<td><input id='txt_compCost' name='txt_compCost' type='text'  value='".$row['COST_COMP']."' $READONLY_FIN></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Error Type:</td>\n";
									$ret .= "		<td><select id='select_errorType' name ='select_errorType' $READONLY_FIN>\n";
									$ret .= "			<option value=''>--Select--</option>\n";

									$sqlEr = " select ERROR_TYPE";
									$sqlEr .= " from nsa.RGA_WC_ERRORS";
									$sqlEr .= " where WC_GROUP = '" .$row['WORKCENTER']. "'";
									QueryDatabase($sqlEr, $resultsEr);
									while ($rowEr = mssql_fetch_assoc($resultsEr)){
										$SELECTED = '';
										$CURRENT = '';

										if (trim($row['ERR_TYPE']) == $rowEr['ERROR_TYPE']) {
											$SELECTED = 'SELECTED';
											$CURRENT = '*';
										}
									...
									$ret .= "		</select></td>\n";
									$ret .= "		<td>Labor Costs:</td>\n";
									$ret .= "		<td><input id='txt_laborCost' name='txt_laborCost' type='text'  value='".$row['COST_LAB']."' $READONLY_FIN></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Vendor ID:</td>\n";
									$ret .= "		<td><input id='txt_vendor' name='txt_vendor' type='text' value='".$row['ID_VND']."' $READONLY_FIN maxlength='6'></input></td>\n";
									$ret .= "		<td>Shipping Costs:</td>\n";
									$ret .= "		<td><input id='txt_shipCost' name='txt_shipCost' type='text'  value='".$row['COST_SHIP']."' $READONLY_FIN></input></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>Part #:</td>\n";
									$ret .= "		<td><input id='txt_isoPartNumber' name='txt_isoPartNumber' type='text'  value='".$row['ID_ITEM_VND']."' $READONLY_FIN maxlength='30'></input></td>\n";
									$ret .= "		<td>Total RGA Costs:</td>\n";
									$ret .= "		<td><input id='txt_totCost' name='txt_totCost' disabled type='text'  value='".$row['COST_TOT']."' $READONLY_FIN></td>\n";
									$ret .= "	</tr>\n";
									$ret .= "	<tr class='dbc'>\n";
									$ret .= "		<td>ISO Status:</td>\n";
									if (empty($row['isoRowID']) ) {
										$ret .= "		<td><select id='select_iso_status' name='select_iso_status' $READONLY_FIN>\n";
									...
									$ret .= "		<td>RGA Status:</td>\n";
									$ret .= "		<td><select id='select_rga_status' name='select_rga_status' onchange=\"checkChangeRgaIsoStatus()\" $READONLY_FIN>\n";
									error_log("ARRAY");
									$RGA_STATUS_ARRAY = array(
										array("","--Select--"),
										array("Open","Open"),
									...
									if (empty($row['isoRowID']) ) {
										$ret .= "	<tr class='dbc'>\n";
										//$ret .= "		<td colspan=4><input id='button_SubmitNew2' name='button_SubmitNew2' type='button' value='Submit' onClick=\"insertNewInvest()\" ></input><div id='div_submitResp2' name='div_submitResp2'></div></td>\n";
										$ret .= "		<td colspan=4>\n";
										$ret .= " 			<input id='button_insertNewInvest' name='button_insertNewInvest' type='button' value='Save' onclick=\"insertNewInvest()\" DISABLED></input>\n";
										$ret .= " 			**Send Email?<select id='sel_Email_insertNewInvest' name='sel_Email_insertNewInvest' onchange=\"checkEnableButton('sel_Email_insertNewInvest','button_insertNewInvest')\">\n";
										$ret .= "   	        <option value=''>--Select--</option>\n";
										$ret .= "   	        <option value='Send'>Send</option>\n";
										$ret .= " 	    	    <option value='NoSend'>Do NOT Send</option>\n";
										...
										if(strpos($UserRow['EMP_ROLE'], ":RGA-FINANCE:") !== FALSE) { // CHANGE BUTTON ACTION FOR FINANCE, ONLY ALLOWING THEM TO UPDATE THE CREDIT INVOICE NUMBER
											$ret .= "	<tr class='dbc'>\n";
											//$ret .= "		<td colspan=4><input id='button_SubmitNew2' name='button_SubmitNew2' type='button' value='Save' onClick=\"updateRgaInvestFinOnly()\"></input><div id='div_submitResp2' name='div_submitResp2'></div></td>\n";
											$ret .= "		<td colspan=4>\n";
											$ret .= " 			<input id='button_updateRgaInvestFinOnly' name='button_updateRgaInvestFinOnly' type='button' value='Save' onclick=\"updateRgaInvestFinOnly()\" ></input>\n";
											//$ret .= " 			**Send Email?<select id='sel_Email_updateRgaInvestFinOnly' name='sel_Email_updateRgaInvestFinOnly' onchange=\"checkEnableButton('sel_Email_updateRgaInvestFinOnly','button_updateRgaInvestFinOnly')\">\n";
											//$ret .= "   	        <option value=''>--Select--</option>\n";
											//$ret .= "   	        <option value='Send'>Send</option>\n";
											//$ret .= " 	    	    <option value='NoSend'>Do NOT Send</option>\n";
											//$ret .= "			</select>\n";
											$ret .= "			<div id='div_submitResp_updateRgaInvestFinOnly' name='div_submitResp_updateRgaInvestFinOnly'></div>\n";
											$ret .= "		</td>\n";													
											$ret .= "	</tr>\n";
										} else {
											$ret .= "	<tr class='dbc'>\n";
											//$ret .= "		<td colspan=4><input id='button_SubmitNew2' name='button_SubmitNew2' type='button' value='Save' onClick=\"updateRgaInvest()\"></input><div id='div_submitResp2' name='div_submitResp2'></div></td>\n";
											$ret .= "		<td colspan=4>\n";
											$ret .= " 			<input id='button_updateRgaInvest' name='button_updateRgaInvest' type='button' value='Save' onclick=\"updateRgaInvest()\" DISABLED></input>\n";
											$ret .= " 			**Send Email?<select id='sel_Email_updateRgaInvest' name='sel_Email_updateRgaInvest' onchange=\"checkEnableButton('sel_Email_updateRgaInvest','button_updateRgaInvest')\">\n";
											$ret .= "   	        <option value=''>--Select--</option>\n";
											$ret .= "   	        <option value='Send'>Send</option>\n";
											$ret .= " 	    	    <option value='NoSend'>Do NOT Send</option>\n";
											$ret .= "			</select>\n";
...
function GenerateHTMLforEmail($rgaNumber) {
	...
	while ($row = mssql_fetch_assoc($results)) {
		...
		while($row2 = mssql_fetch_assoc($results2)){
			...
			$y = $row2['SEQ_LINE_SHIP'];
			$z = $y + 1;
			$ret .= "	<tr style='background-color: #DDE5ED; color: #black;' id='tr_itm".$y.".1' style='".$style."'>\n";
			$ret .= "       <td colspan=2></td>\n";
			$ret .= "		<td>Item Recieved".$y.":</td>\n";
		...
		$ret .= "		<td>CAR #</td>\n";
		$ret .= "		<td colspan=2><input id='txt_carNumber' name='txt_carNumber' type='text' READONLY value='".$row['CAR_NUMBER']."'></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td colspan=2>Proposed action approved by:</td>\n";
		$ret .= "		<td colspan=2><input id='txt_approve' name='txt_approve' type='text' value='".$row['APPROVED_BY']."' READONLY></input></td>\n";
		$ret .= "		<td>Date (yyyy-mm-dd):</td>\n";
		$ret .= "		<td colspan=2><input id='txt_dateSubmit' name='txt_dateSubmit' type='text' value='".$row['riDATE_APPROVED']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "</table>\n";
		...
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Department:</td>\n";
		$ret .= "		<td><input id='txt_department' name='txt_department' type='text' value='".$row['DEPARTMENT']."' READONLY></input></td>\n";
		$ret .= "		<td>Request/Error:</td>\n";
		$ret .= "		<td><input id='txt_req_err' name='txt_req_err' type='text' value='".$row['REQ_ERR']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Workcenter:</td>\n";
		$ret .= "		<td><input id='txt_workcenter' name='txt_workcenter' type='text' value='".$row['WORKCENTER']."' READONLY></input></td>\n";
		$ret .= "		<td>Credit Invoice #:</td>\n";
		$ret .= "		<td><input id='txt_invoice' name='txt_invoice' type='text' value='".$row['ID_INVC_CRED']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Team/Individual:</td>\n";
		$ret .= "		<td><input id='txt_team' name='txt_team' type='text' value='".$row['ID_TEAM']."' READONLY></input></td>\n";
		$ret .= "		<td>Component Costs:</td>\n";
		$ret .= "		<td><input id='txt_compCost' name='txt_compCost' type='text' value='".$row['COST_COMP']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Error Type:</td>\n";
		$ret .= "		<td><input id='txt_err_type' name='txt_err_type' type='text' value='".$row['ERR_TYPE']."' READONLY></input></td>\n";
		$ret .= "		<td>Labor Costs:</td>\n";
		$ret .= "		<td><input id='txt_laborCost' name='txt_laborCost' type='text' value='".$row['COST_LAB']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Vendor ID:</td>\n";
		$ret .= "		<td><input id='txt_vendor' name='txt_vendor' type='text' value='".$row['ID_VND']."' READONLY></input></td>\n";
		$ret .= "		<td>Shipping Costs:</td>\n";
		$ret .= "		<td><input id='txt_shipCost' name='txt_shipCost' type='text' value='".$row['COST_SHIP']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>Part #:</td>\n";
		$ret .= "		<td><input id='txt_isoPartNumber' name='txt_isoPartNumber' type='text' value='".$row['ID_ITEM_VND']."' READONLY></input></td>\n";
		$ret .= "		<td>Total RGA Costs:</td>\n";
		$ret .= "		<td><input id='txt_totCost' name='txt_totCost' type='text' value='".$row['COST_TOT']."' READONLY></input></td>\n";
		$ret .= "	</tr>\n";
		$ret .= "	<tr style='background-color: #DDE5ED; color: #black;'>\n";
		$ret .= "		<td>ISO Status:</td>\n";
		$ret .= "		<td><input id='txt_rga_status' name='txt_rga_status' type='text'  value='".$row['RGA_ISO_STATUS']."' READONLY></input></td>\n";
		$ret .= "		<td>RGA Status:</td>\n";
