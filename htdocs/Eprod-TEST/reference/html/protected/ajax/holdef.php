<?php
	...
	if ($retval == 0) {
		...
		if ($retval == 0) {
			...
			if (isset($_POST["action"]) && isset($_POST["dh"]) && isset($_POST['dscr']) && $_POST['action'] == 'AddNew'){
				$dh = $_POST["dh"];
				$dscr = stripIllegalChars2($_POST["dscr"]);
						
				

				$sql =  "insert into nsa.HOLIDAY_DEF ( ";
				$sql .= "	DATE_HOL, ";
				$sql .= "	DESCR, ";
				$sql .= "	DATE_ADD, ";
				$sql .= "	ID_USER_ADD, ";
