			...
			if ($UserRow['PERM_HR'] == '1') {
				...
				if (isset($_POST["weekOf"]) && isset($_POST["team"]))  {
					...
					while ($rowX = mssql_fetch_assoc($resultsX)) {
						...
						$ret .= " 		<td class='sample' colspan=10>". $new_weekOf . "</td>\n";
						$ret .= " 	</tr>\n";
						$ret .= " 	<tr>\n";
						$ret .= " 		<td>\n";
						...
						foreach ($a_team_members as $member) {
							...
							$sql .= "   and ";
							$sql .= " 	tx.CODE_TRX in (305) ";
							$sql .= "   and ";
							$sql .= " 	ltrim(tx.ID_BADGE_TEAM) = '" . $Team . "' ";
							$sql .= " order by ";
							$sql .= " 	ID_BADGE asc, ";
							$sql .= " 	DATE_TRX asc, ";
							$sql .= " 	time_trx asc ";
							...
							while ($row = mssql_fetch_assoc($results)) {
								...
								while ($row2 = mssql_fetch_assoc($results2)) {
									$sql3 =  "select ";
									$sql3 .= "	convert(char(10),tx.DATE_TRX,101) as DATE_TRX2, ";
									$sql3 .= "	CONVERT(varchar(8), tx.DATE_TRX, 112) as DATE_TRX3, ";
									$sql3 .= "	e.NAME_EMP, ";
									$sql3 .= "	e.CODE_USER_1_DC, ";
									$sql3 .= "	tx.* ";
									$sql3 .= " from ";
									$sql3 .= "	#temp_trx tx, ";
									$sql3 .= "	nsa.DCEMMS_EMP e ";
									$sql3 .= " where ";
									$sql3 .= " 	ltrim(tx.ID_BADGE) = '". $member . "'";
									$sql3 .= "   and ";
									$sql3 .= " 	tx.ID_BADGE = e.ID_BADGE ";
									$sql3 .= "   and ";
									$sql3 .= " 	tx.CODE_TRX in (105) ";
									$sql3 .= "   and ";
									$sql3 .= " 	tx.DATE_TRX = '" . $row['DATE_TRX'] . "' ";
									$sql3 .= "   and ";
									$sql3 .= " 	tx.TIME_TRX between '" . $row2['TIME_TRX'] . "' and '" . $row['TIME_TRX'] . "' ";
									$sql3 .= " order by ";
									$sql3 .= " 	DATE_TRX asc, ";
									$sql3 .= " 	ID_BADGE asc, ";
									$sql3 .= " 	time_trx asc ";
									...
									while ($row3 = mssql_fetch_assoc($results3)) {
										$sql4 =  "select top 1 ";
										$sql4 .= "	convert(char(10),tx.DATE_TRX,101) as DATE_TRX2, ";
										$sql4 .= "	CONVERT(varchar(8), tx.DATE_TRX, 112) as DATE_TRX3, ";
										$sql4 .= "	e.NAME_EMP, ";
										$sql4 .= "	e.CODE_USER_1_DC, ";
										$sql4 .= "	tx.* ";
										$sql4 .= " from ";
										$sql4 .= "	#temp_trx tx, ";
										$sql4 .= "	nsa.DCEMMS_EMP e ";
										$sql4 .= " where ";
										$sql4 .= " 	ltrim(tx.ID_BADGE) = '". $member . "'";
										$sql4 .= "   and ";
										$sql4 .= " 	tx.ID_BADGE = e.ID_BADGE ";
										$sql4 .= "   and ";
										$sql4 .= " 	tx.CODE_TRX in (104) ";
										$sql4 .= "   and ";
										$sql4 .= " 	tx.DATE_TRX = '" . $row['DATE_TRX'] . "' ";
										$sql4 .= "   and ";
										$sql4 .= " 	tx.TIME_TRX between '" . $row2['TIME_TRX'] . "' and '" . $row['TIME_TRX'] . "' ";
										$sql4 .= "   and ";
										$sql4 .= " 	tx.TIME_TRX <= '" . $row3['TIME_TRX'] . "' ";
										$sql4 .= " order by ";
										$sql4 .= " 	DATE_TRX asc, ";
										$sql4 .= " 	ID_BADGE asc, ";
										$sql4 .= " 	time_trx desc ";
										...
										while ($row4 = mssql_fetch_assoc($results4)) {
											...
											$prevts = strtotime($prev);
											$curr = $row4['DATE_TRX3'] . " " . str_pad($row4['TIME_TRX'],6,"0",STR_PAD_LEFT);
											$currts = strtotime($curr);
									...
									$name = $row['NAME_EMP'];
									$team_std = $row['ID_BADGE_TEAM_STD'];
									$prev = $row2['DATE_TRX3'] . " " . str_pad($row2['TIME_TRX'],6,"0",STR_PAD_LEFT);
									$prevts = strtotime($prev);
									$curr = $row['DATE_TRX3'] . " " . str_pad($row['TIME_TRX'],6,"0",STR_PAD_LEFT);
									$currts = strtotime($curr);
