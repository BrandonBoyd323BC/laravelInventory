<?php
	...
	PrintHeaderJQ2('Order Prep Labels Ready','default.css','opLabelsReady.js');
	...
	if ($retval == 0) {
		...
		if ($retval == 0) {
			...
			print(" <form id='opLabels_Ready_Form' method='post' enctype='multipart/form-data'>\n");			
			print(" <table>\n");
			print(" 	<tr>\n");
			print(" 		<th colspan=2>Enter New Completed Records: </th>\n");
			print(" 	</tr>\n");
			print("		<tr id='tr_so1'>\n");
