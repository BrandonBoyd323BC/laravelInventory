<?php
	...
	PrintHeaderJQ('RGA / Customer Complaint Form','default.css','rgaformV2.js');
	if ($ua['short_name'] == 'Chrome') {
		...
		if ($retval == 0) {
			...
			if ($retval == 0) {
				...
				print("					<option value='Open, Waiting for Return'>Open, Waiting for Return</option>\n");
				print("					<option SELECTED value='Open, Response to Customer Required'>Open, Response to Customer Required</option>\n");
				print("					<option value='Open, Inspection Required'>Open, Inspection Required</option>\n");
				print("					<option value='ISO Action Required'>ISO Action Required</option>\n");
...
*/
				...
				print("     <tr>\n");
				print(" 		<td>Filter Classification: <select id='filterClassification' name='filterClassification' onChange=\"filterRgaStatus()\">\n");
				print("				<option value='ALL' SELECTED>ALL</option>\n");
				print("				<option value='PQE'>Product Quality Error</option>\n");
				print("				<option value='NQE'>Non-Quality Error</option>\n");
				print("			</select></td>\n");
				print("		</tr>\n");			
				...
				print("		</tr>\n");
				print("     <tr>\n");
				print(" 		<td>Filter Cust Name: <input id='filterCustName' name='filterCustName' type='textbox' value='ALL' onblur=\"filterRgaStatus()\"></input></td>\n");
				print("		</tr>\n");
				print("     <tr>\n");
				...
				print("		</tr>\n");
				print("     <tr>\n");
				print(" 		<td>Filter Item Number: <input id='filterItemID' name='filterItemID' type='textbox' value='ALL' onblur=\"filterRgaStatus()\"></input></td>\n");
				print("		</tr>\n");				
				print("     <tr>\n");
				...
				print(" <input type=hidden id='sortField' value='rbDATE_ADD'>\n");
				print(" <input type=hidden id='sortDir' value='asc'>\n");
