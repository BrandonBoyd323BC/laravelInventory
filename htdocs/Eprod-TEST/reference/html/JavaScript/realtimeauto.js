...
function sendValue(str){
	...
	//$.post("../ajax/realtimeauto.php",{ sendValue: str, from: 'rt', df: df, dt: dt },
	$.post("../ajax/realtimeauto.php",{ sendValue: str, from: 'rt'},
	function(data){
...
function dashsendValue(str){
	...
	$.post("../protected/ajax/realtimeauto.php",{ sendValue: str, from: 'dash', df: df, dt: dt },
